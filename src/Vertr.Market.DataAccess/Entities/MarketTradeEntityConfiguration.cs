...
internal sealed class MarketTradeEntityConfiguration : IEntityTypeConfiguration<MarketTradeDbo>
{
    public void Configure(EntityTypeBuilder<MarketTradeDbo> builder)
    {
